...
<body class="animsition">
                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="/admin/products">
                                <i class="fa-solid fa-box-open-full"></i>Products</a>
                        </li>
                        <li>
                            <a href="/admin/categories">
                                <i class="fa fa-cubes" aria-hidden="true"></i>Categories</a>
                        </li>
                        ...
                        <li>
                            <a href="/admin/role">
                                <i class="fas fa-user-cog"></i>Role</a>
                        </li>
                        <li>
                            <a href="/admin/city">
                                <i class="fa-solid fa-city"></i>City</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="/admin/province">
                                <i class="fa fa-map-signs" aria-hidden="true"></i>Province</a>
                        </li>
                        <li>
                            <a href="/admin/street">
                                <i class="fas fa-street-view"></i>Street</a>
                        </li>
                        <li>
                            <a href="chart.html">
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="/admin/city">
                                <i class="fas fa-car-building"></i>City</a>
                        </li>
                        <li>
                            <a href="/admin/location">
                                <i class="fa fa-map-marker" aria-hidden="true"></i>Location</a>
                        ...
                        <li>
                            <a href="/admin/province">
                                <i class="fa fa-map-signs" aria-hidden="true"></i></i>Province</a>
                        </li>
                        <li>
                            <a href="/admin/street">
                                <i class="fas fa-street-view"></i>Street</a>
    ...
    <!-- Bootstrap JS-->
    <script src="{{asset('assets/vendor/jquery-3.2.1.min.jsS')}}"></script>
